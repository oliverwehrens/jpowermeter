...
public class ReadingBuffer {
    ...
    public SmartMeterReading getSmartMeterReadingInKwh() {
        ...
        smartMeterReadingInKwh.consumptionTotal.value = smartMeterReading.consumptionTotal.value.divide(new BigDecimal(1000));
        smartMeterReadingInKwh.consumptionTotal.unit = "kWh";
        smartMeterReadingInKwh.consumptionOne.value = smartMeterReading.consumptionOne.value.divide(new BigDecimal(1000));
        smartMeterReadingInKwh.consumptionOne.unit = "kWh";
        smartMeterReadingInKwh.consumptionTwo.value = smartMeterReading.consumptionTotal.value.divide(new BigDecimal(1000));
